...
{
    $product = $productId ? productGet($productId) : null;
    require_once 'views/product_view.php';
...
function productCreate()
{
    ...
    if ($result) {
        header('Location: admin-product.php?success=Product created successfully');
    } else {
...
function productUpdate($productId)
{
    ...
    $result = productUpdate($productId, $productData);
...
{
    $result = productDelete($productId);

    if ($result) {
        // Redirect or render a success message
        header('Location: admin-product.php?success=Product deleted successfully');
    } else {
